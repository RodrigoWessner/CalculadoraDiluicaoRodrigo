...
public class GrupoMedicamentoService {
	...
	public ResponseEntity<GrupoMedicamentoDto> criar(@Valid GrupoMedicamentoForm grupoMedicamentoForm, UriComponentsBuilder uriBuilder) {//pega info do corpo
	...
	public ResponseEntity<GrupoMedicamentoDto> atualizar(BigInteger id, @Valid GrupoMedicamentoForm grupoMedicamentoForm){
