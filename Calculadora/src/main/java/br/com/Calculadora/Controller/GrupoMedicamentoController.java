...
public class GrupoMedicamentoController {
	...
	public Iterable<GrupoMedicamento> lista() {
		...
		return GrupoMedicamentoDto.converter(grupoMedicamento);*/
	...
	public ResponseEntity<GrupoMedicamentoDto> criar(@RequestBody GrupoMedicamentoForm grupoMedicamentoForm, UriComponentsBuilder uriBuilder) {//pega info do corpo
	...
	@Transactional
	public ResponseEntity<GrupoMedicamentoDto> atualizar(@PathVariable BigInteger id, GrupoMedicamentoForm grupoMedicamentoForm){
