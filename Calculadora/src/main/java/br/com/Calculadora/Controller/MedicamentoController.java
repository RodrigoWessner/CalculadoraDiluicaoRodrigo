...
public class MedicamentoController {
	...
	public ResponseEntity<MedicamentoDto> listar(@RequestParam BigInteger id) {
		return (medicamentoService.listar(id));
	}

	@ApiOperation(value = "Retorna entidade do nome")
	@RequestMapping(value = "/listar/{nome}", method = RequestMethod.GET, params = "nome")
	public ResponseEntity<List<MedicamentoDto>> listar(@RequestParam String nome) {
		return (medicamentoService.listar(nome));
	}

	@ApiOperation(value = "Criar Medicamento")
	@RequestMapping(value = "/criar", method = RequestMethod.POST)
	@Transactional
	public ResponseEntity<MedicamentoConfiguracaoDto> criar(
			@RequestBody MedicamentoConfiguracaoForm medicamentoConfiguracaoForm, UriComponentsBuilder uriBuilder) {
	...
	@Transactional
	public ResponseEntity<MedicamentoConfiguracaoDto> atualizar(@PathVariable BigInteger id,
			@RequestBody MedicamentoConfiguracaoForm medicamentoConfiguracaoForm) {
